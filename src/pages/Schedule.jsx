...
const localBackupSchedule = {
  'ІНб12340д': [
    { date: '2026-05-25', time: '13:45 – 14:55', title: 'Комп’ютерна графіка та анімація (Лаб) - Горбатовський Д.В.', type: 'Дистанційно', room: '' },
    { date: '2026-05-25', time: '15:10 – 16:20', title: 'Комп’ютерна графіка та анімація (Лаб) - Співак С.М.', type: 'Дистанційно', room: '' },
    { date: '2026-05-26', time: '17:40 – 18:50', title: 'Програмування: Крос-платформне програмування (Л) - Дібрівний О.А.', type: 'Дистанційно', room: '' },
    { date: '2026-05-27', time: '13:45 – 14:55', title: 'Моделювання систем і процесів (Л) - Машкіна І.В.', type: 'Дистанційно', room: '' }
  ],
  'ІНб22340д': [
    { date: '2026-05-25', time: '13:45 – 14:55', title: 'Комп’ютерна графіка та анімація (Лаб) - Горбатовський Д.В.', type: 'Дистанційно', room: '' },
    { date: '2026-05-26', time: '17:40 – 18:50', title: 'Програмування: Крос-платформне (Л) - Дібрівний О.А.', type: 'Дистанційно', room: '' }
  ],
  'ІН622340д': [
    { date: '2026-05-25', time: '13:45 – 14:55', title: 'Комп’ютерна графіка та анімація (Лаб) - Горбатовський Д.В.', type: 'Дистанційно', room: '' },
    { date: '2026-05-26', time: '17:40 – 18:50', title: 'Програмування: Крос-платформне (Л) - Дібрівний О.А.', type: 'Дистанційно', room: '' }
...
export default function Schedule() {
  ...
  const [activeGroup, setActiveGroup] = useState(
    () => localStorage.getItem('selectedGroup') || 'ІН622340д'
  );
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 bg-white/5 border border-white/10 px-4 py-2.5 rounded-2xl">
          ...
          >
            ...
            <option value="ІН622340д">ІН622340д</option>
          </select>
        </div>
      </div>
